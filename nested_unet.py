...
if __name__ == "__main__":
    ...
    debug_model = NestedUNet(in_channels=args.channel, n_classes=2, depth=3, batch_norm=True, padding=True).to(device)

    summary(debug_model, (args.channel, args.height, args.width))